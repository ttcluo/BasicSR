...
class ICMEVSRx3_FG_SPM(nn.Module):
...
@ARCH_REGISTRY.register()
class ICMEVSRx3_warp_SPM(nn.Module):
    """IconVSR, proposed also in the BasicVSR paper  IconVSRx2_FS_fg
    """
...
@ARCH_REGISTRY.register()
class ICMEVSRx3_FG_only(nn.Module):
    """IconVSR, proposed also in the BasicVSR paper  IconVSRx2_FS_fg
    """
...
@ARCH_REGISTRY.register()
class ICMEVSRx3_warp_only(nn.Module):
    """IconVSR, proposed also in the BasicVSR paper  IconVSRx2_FS_fg
    """
...
@ARCH_REGISTRY.register()
class ICMEVSRx3_FG_FB_SPM(nn.Module):
    """IconVSR, proposed also in the BasicVSR paper  IconVSRx2_FS_fg
    """
